...
### Why doesn't the text composition system work well with onSearch in controlled mode? {#faq-controlled-chinese}
...
### Why won't a controlled open AutoComplete display a drop-down menu when options are empty? {#faq-empty-options}
